class Agent:
    ...
    @param state will be a tuple (messages, hasArrow, hasGold, orientation)      orientation is currently useless.
           ...
           The state[0]: messages will be a list of strings which might include: "CONTINUE", "BREEZE", "STENCH", "GLITTER", "SHOOT", "KILLED-WUMPUS" .
