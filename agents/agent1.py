class Agent:
    def __init__(self):
        ...
        self.board=[[set() for j in range (3)] for i in range(3)]
        
    ##TODO: define the functions you need here
    """
    predict(visible_board) will read in a current board which shows the state of the game that should be visible to the robot and return the move the agent will make based on the current information. 
